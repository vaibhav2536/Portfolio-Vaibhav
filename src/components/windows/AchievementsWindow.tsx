          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            {achievements.map((achievement) => {
              ...
              return (
                <div
                  key={achievement.id}
                  className="bg-gray-800 rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow duration-200"
                >
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between flex-col sm:flex-row gap-2">
                        <span className={`text-xs font-semibold px-2 py-1 rounded-full ${colorClasses} order-2 sm:order-1`}>
                        ...
                        {(achievement as any).link && (
                          <a
                            ...
                            className="flex items-center space-x-1 text-blue-400 hover:text-blue-300 text-xs sm:text-sm font-medium order-1 sm:order-2"
                          >
                            <span>View</span>
