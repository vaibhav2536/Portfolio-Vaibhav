...
const Dock: React.FC<DockProps> = ({ onOpenWindow, minimizedWindows = [] }) => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50">
      <motion.div 
        className="backdrop-blur-2xl rounded-3xl px-4 py-3 shadow-2xl border"
        style={{
          ...
          {dockItems.map((item, index) => {
            ...
            return (
              <div key={item.id} className="relative">
                {/* Enhanced Tooltip */}
                <motion.div
                  className="absolute -top-16 left-1/2 transform -translate-x-1/2 backdrop-blur-xl text-white text-sm px-3 py-2 rounded-xl whitespace-nowrap pointer-events-none border"
                  style={{
                ...
                <motion.button
                  ...
                  className="relative w-16 h-16 backdrop-blur-xl rounded-2xl shadow-lg border flex items-center justify-center overflow-hidden group"
                  style={{
                ...
                >
                  ...
                  >
                    <Icon className="w-7 h-7 text-white/90 drop-shadow-lg" />
                  </motion.div>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-transparent rounded-2xl pointer-events-none" />
